...
class M_View_Helper_Ad extends Zend_View_Helper_Abstract {
	public function ad() {
		...
		$admob_params = array(
			'PUBLISHER_ID'      => 'a14e2feea55d1e7', // Required to request ads. To find your Publisher ID, log in to your AdMob account and click on the "Sites & Apps" tab.
		...
		return $this->_admob_request($admob_params);
	}
	...
	protected function _admob_request($admob_params) {
